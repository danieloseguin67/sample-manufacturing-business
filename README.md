# Manufacturing Business - Angular Template

A professional Angular 17 template website for manufacturing industry businesses with multi-language support and database connectivity.
...
- ✅ **Comprehensive Pages**: 11 fully-featured pages for manufacturing businesses
- ✅ **Routing**: Multi-page application with navigation
- ✅ **Internationalization**: Complete i18n implementation using ngx-translate

## Pages Included

1. **Home Page** - Hero section with CTA buttons and manufacturing capabilities showcase
2. **About Us** - Company history, mission, vision, leadership team, and certifications
3. **Products** - Product categories with detailed specifications and quote requests
4. **Industries Served** - Automotive, Aerospace, Consumer Goods, Medical Devices, Energy
5. **Manufacturing Capabilities** - Technologies, facilities, and quality assurance
6. **Sustainability & Innovation** - Eco-friendly practices and R&D initiatives
7. **Careers** - Job listings, company culture, benefits, and internship programs
8. **Blog/News** - Industry insights, company updates, and case studies
9. **Contact** - Contact form, address, phone, email, and map integration
10. **Client Portal** - Secure login for clients to track orders, view invoices, and project status
11. **Footer** - Quick links, newsletter signup, and legal information
...
│   │   ├── pages/
│   │   │   ├── home/                # Homepage with hero and capabilities
│   │   │   ├── about/               # About us page
│   │   │   ├── products/            # Products page
│   │   │   ├── industries/          # Industries served page
│   │   │   ├── capabilities/        # Manufacturing capabilities page
│   │   │   ├── sustainability/      # Sustainability & innovation page
...
The application supports three languages for the manufacturing industry:
- **English** (en) - Default
- **French** (fr) - Français
- **Spanish** (es) - Español

All pages, navigation, and content are fully translated including:
...
The application is configured to connect to SQL Server for manufacturing data:

- **Server**: localhost
- **User**: developer
- **Password**: Storedindotenv
- **Database**: manufacturing_business
...
- Add product images and specifications
- Update leadership team information
- Customize certifications and awards
- Add actual job listings
- Connect blog to a CMS or database
- Implement actual authentication for client portal
